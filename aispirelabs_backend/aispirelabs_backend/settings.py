"""
Django settings for aispirelabs_backend project.
...
SECRET_KEY = 'django-insecure-#xeje2-lk6^j5-nqrew1yt8jw8luc8l31xm$#l7a%cnzf3h&u7'
...
INSTALLED_APPS = [
    ...
    'acharya_ai.apps.AcharyaAiConfig',
    'corsheaders',
]
